...
module.exports = "<button (click)=\"listAllBucket()\">List all Bucket</button>\n"
...
var ListComponent = /** @class */ (function () {
  ...
  */
    ListComponent.prototype.listAllBucket = function () {
        var options = {
...
var UploadComponent = /** @class */ (function () {
    ...
    UploadComponent.prototype.fileChanged = function (files) {
        this.file = files[0];
        //  console.log(file);
    };
    UploadComponent.prototype.sendFile = function () {
        var options = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({
                'Content-Type': 'application/json',
            })
...
module.exports = __webpack_require__(/*! /Users/sabachadi/Documents/s3project/ecs-app-front/src/main.ts */"./src/main.ts");
